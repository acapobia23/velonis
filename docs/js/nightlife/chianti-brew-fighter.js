document.addEventListener("DOMContentLoaded", () => {
  ...
  if (galleryContainer) {
    const imageFiles = ["01.jpg","02.jpg","03.jpg","04.jpg","05.jpg","06.jpg","07.jpg",]; //file name of pic
    const basePath = "../../assets/img/boxes/nightlife/chianti-brew-fighter/"; //path pic
